const services = [
  {
    ...
    description:
      "Escáner OBD-II de última generación para identificar cualquier falla en tu vehículo con precisión.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Revisión completa, cambio de pastillas, discos, amortiguadores y alineación para tu seguridad.",
    icon: (
      <svg className="size-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Aceite sintético, semi-sintético o convencional con filtros de alta calidad. Servicio express disponible.",
    icon: (
      <svg className="size-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Reparación y reconstrucción de motores, cajas automáticas y manuales por especialistas.",
    icon: (
      <svg className="size-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Diagnóstico y reparación de alternadores, baterías, sistemas de encendido y cableado completo.",
    icon: (
      <svg className="size-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Recarga de gas, revisión de compresor, reparación de fugas y mantenimiento preventivo del A/C.",
    icon: (
      <svg className="size-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <h2 className="max-w-xl text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
            ...
            <span className="text-brand">Cada Necesidad</span>
          </h2>
          <a
            href="#contact"
